                ...
                success:function(r){
                   ...
                   if(r.code=='100000'){
                        ...
                        for (let index = 0; index < r.list.length; index++) {
                            html+=' <div onclick=show2('+"'"+r.list[index].detailurl+"'"+')><p>'+r.list[index].article+'</p><p>'+r.list[index].source+'</p><img style="height: 1.5rem;" src="'+r.list[index].icon+'"/></div>' ;
                        }
                       ...
                       var html=''
                       for (let index = 0; index < r.list.length; index++) {
                          html+='<div onclick=show2('+"'"+r.list[index].detailurl+"'"+')><p>'+r.list[index].name+'</p><img style="height: 1.5rem;" src="'+r.list[index].icon+'"/><p>'+r.list[index].info+'</p></div>';
                       }
                        $(".chat-thread").append(' <li class="lift">'+r.text+html+'</li>');
                        v.heighttop();
